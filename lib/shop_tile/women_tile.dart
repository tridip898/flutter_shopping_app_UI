...
class WomenTile extends StatelessWidget {
  final String itemName;
  final String description;
  final String price;
  final String icon;
  final int percentage;
  const WomenTile({Key? key, required this.itemName, required this.description, required this.price, required this.icon, required this.percentage}) : super(key: key);
